...
typedef actionlib::SimpleActionClient<kinova_msgs_ros2::ArmJointAnglesAction> ArmJoint_actionlibClient;
typedef actionlib::SimpleActionClient<kinova_msgs_ros2::ArmPoseAction> ArmPose_actionlibClient;
typedef actionlib::SimpleActionClient<kinova_msgs_ros2::SetFingersPositionAction> Finger_actionlibClient;
...
void sendFingerGoal(const visualization_msgs::InteractiveMarkerFeedbackConstPtr &feedback)
{
    ...
    kinova_msgs_ros2::SetFingersPositionGoal goal;
...
void sendArmPoseGoal(geometry_msgs::PoseStamped &endeffector_pose)
{
    ...
    kinova_msgs_ros2::ArmPoseGoal goal;
    client.waitForServer();
...
void sendArmJointGoal(const std::string marker_name, double joint_offset)
{
    ...
    kinova_msgs_ros2::ArmJointAnglesGoal goal;
...
// %Tag(CurrentJoint)%
void currentJointsFeedback(const kinova_msgs_ros2::JointAnglesConstPtr joint_command)
{
...
// %Tag(CurrentPose)%
void currentPoseFeedback(const kinova_msgs_ros2::KinovaPoseConstPtr pose_command)
{
