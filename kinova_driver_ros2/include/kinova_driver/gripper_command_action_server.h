...
#include <kinova_msgs_ros2/SetFingersPositionAction.h>
...
namespace kinova
{
    class GripperCommandActionController
    {
        ...
        typedef actionlib::ActionClient<kinova_msgs_ros2::SetFingersPositionAction> SFPAC;
    ...
    private:
        ...
        kinova_msgs_ros2::FingerPositionConstPtr last_finger_state_;
        ...
        void controllerStateCB(const kinova_msgs_ros2::FingerPositionConstPtr &msg);
